...
func (na *_Any__ReprAssembler) BeginMap(sizeHint int64) (datamodel.MapAssembler, error) {
	...
	return nil, schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "BeginMap called but is not valid for any of the kinds that are valid members of this union"}
}
func (na *_Any__ReprAssembler) BeginList(sizeHint int64) (datamodel.ListAssembler, error) {
	...
	return nil, schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "BeginList called but is not valid for any of the kinds that are valid members of this union"}
}
...
func (na *_Any__ReprAssembler) AssignBool(v bool) error {
	...
	return schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "AssignBool called but is not valid for any of the kinds that are valid members of this union"}
}
func (na *_Any__ReprAssembler) AssignInt(v int64) error {
	...
	return schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "AssignInt called but is not valid for any of the kinds that are valid members of this union"}
}
func (na *_Any__ReprAssembler) AssignFloat(v float64) error {
	...
	return schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "AssignFloat called but is not valid for any of the kinds that are valid members of this union"}
}
func (na *_Any__ReprAssembler) AssignString(v string) error {
	...
	return schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "AssignString called but is not valid for any of the kinds that are valid members of this union"}
}
func (na *_Any__ReprAssembler) AssignBytes(v []byte) error {
	...
	na.w.x = x
	if na.ca1 == nil {
		na.ca1 = &_Bytes__ReprAssembler{}
	}
	na.ca1.w = x
	na.ca1.m = na.m
	return na.ca1.AssignBytes(v)
}
func (na *_Any__ReprAssembler) AssignLink(v datamodel.Link) error {
	...
	return schema.ErrNotUnionStructure{TypeName: "schema.Any.Repr", Detail: "AssignLink called but is not valid for any of the kinds that are valid members of this union"}
}

...
var lengthBufExtraInfo = []byte{130}
...
func (t *ExtraInfo) MarshalCBOR(w io.Writer) error {
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(t.PeerID))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string(t.PeerID)); err != nil {
		return err
	}
...
func (t *SnapShot) UnmarshalCBOR(r io.Reader) error {
	*t = SnapShot{}
	...
	if maj != cbg.MajMap {
		return fmt.Errorf("expected a map (major types 5)")
	}
	if extra > 4096 {

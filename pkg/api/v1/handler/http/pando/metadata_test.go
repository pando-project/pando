...
func TestMetadataList(t *testing.T) {
	t.Run("TestMetadataList", func(t *testing.T) {
		...
		t.Run("Given an monkey error, should return a monkey error resp", func(t *testing.T) {
...
func TestMetadataSnapshot(t *testing.T) {
	t.Run("TestMetadataSnapshot", func(t *testing.T) {
		//responseRecorder := httptest.NewRecorder()
		//testContext, _ := gin.CreateTestContext(responseRecorder)

		t.Run("Given a non-nil snapshot, should return the snapshot", func(t *testing.T) {
			// ToDo: mock snapshot
			//testCidListStr := []string{

...
func TestOptions(t *testing.T) {
	t.Run("TestOptions", func(t *testing.T) {
		...
		t.Run("flag values should be default value before parse function execute", func(t *testing.T) {
			//asserts := assert.New(t)
			//asserts.Equal("config.yaml", opt.ConfigFile)
		...
		t.Run("check whether the value of flags are the value set in the specified file", func(t *testing.T) {

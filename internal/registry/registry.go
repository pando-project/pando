...
func NewRegistry(cfg *config.Discovery, cfglevel *config.AccountLevel, dstore datastore.Datastore, disco discovery.Discoverer, core legs_interface.PandoCore) (*Registry, error) {
